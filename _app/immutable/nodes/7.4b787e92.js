import{s as i,f as r,g as l,_ as h,j as c,i as d,r as o,d as p}from"../chunks/scheduler.a4b5f5fa.js";import{S as u,i as f}from"../chunks/index.2698e3a4.js";function b(s){let e,a=`<div class="text-4xl font-bold">About VPS</div> <p>VPS is community maintained database for Virtual Pinball related files and infos.</p> <p>Through the site you can search new &amp; old releases of pinball tables and additional files you
		...
		backend. This way though the site can continue to run until github closes its doors.</p>`;return{c(){e=r("div"),e.innerHTML=a,this.h()},l(t){e=l(t,"DIV",{class:!0,"data-svelte-h":!0}),h(e)!=="svelte-1fhjwr8"&&(e.innerHTML=a),this.h()},h(){c(e,"class","flex flex-col gap-4")},m(t,n){d(t,e,n)},p:o,i:o,o,d(t){t&&p(e)}}}class m extends u{constructor(e){super(),f(this,e,null,b,i,{})}}export{m as component};
