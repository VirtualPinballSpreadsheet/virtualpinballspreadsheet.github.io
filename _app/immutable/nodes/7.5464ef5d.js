import{s as n,f as r,g as l,_ as h,j as c,i as p,r as o,d}from"../chunks/scheduler.4bea28c8.js";import{S as u,i as f}from"../chunks/index.10be7516.js";function b(s){let e,a=`<div class="text-4xl font-bold">About VPS</div> <p>VPS is community maintained database for Virtual Pinball related files and infos.</p> <p>Through the site you can search new &amp; old releases of pinball tables and additional files you
		...
		to find it.</p> <h1 class="text-4xl font-bold pt-8">Search</h1> <p>Use the search to find what you are looking for! On the right side of the searchbar, you can
		change what type of file you are looking for.</p> <h1 class="text-xl font-bold pt-4">Filter</h1> <p>Click the filter icon to the right of the search box to open the filter section. The filter
		...
		the preview as you go.</p> <p>The &quot;Format Name&quot; options let you adjust the generated tablesnames to a desired format.</p> <h1 class="text-xl font-bold pt-4">Bookmarks</h1> <p>Maybe you are setting up a new library and want to brwose through all of VPS. Maybe you want to
		...
		fetch this file first to get the timestamp of the latest release:</p> <code>https://virtualpinballspreadsheet.github.io/vps-db/lastUpdated.json</code> <p>If your version is outdated, you might fetch the latest.</p> <h1 class="text-4xl font-bold pt-8">Contribute</h1> <p>If you want to contribute to either the content of the site or actual coding, feel free to
		...
		that is generated via a github action.</p> <p>The goal for this architecture was to be completely free and untied to anybody in particular. We
		...
		can continue to run until github closes its doors.</p>`;return{c(){e=r("div"),e.innerHTML=a,this.h()},l(t){e=l(t,"DIV",{class:!0,"data-svelte-h":!0}),h(e)!=="svelte-1wqqpg3"&&(e.innerHTML=a),this.h()},h(){c(e,"class","flex flex-col gap-4")},m(t,i){p(t,e,i)},p:o,i:o,o,d(t){t&&d(e)}}}class m extends u{constructor(e){super(),f(this,e,null,b,n,{})}}export{m as component};
