import{a1 as xr,s as Bt,e as Or,i as we,d as f,B as _t,f as p,l as O,g,h as b,m as N,j as u,G as c,H as nr,r as Mt,Y as Ci,a as C,c as k,R as Ie,n as H,$ as tr,Z as Nr,k as vt,T as ie,I as Is}from"./scheduler.c1c84dbf.js";import{S as Vt,i as Ht,a as bt,g as ki,t as Lt,c as Ri,b as sr,d as ir,m as ar,e as or}from"./index.64b0efba.js";import{F as Pi,k as Di,e as qe,D as Rn,E as Oi,A as Ni,G as Mi,H as Li,I as Ui,J as Fi,K as Bi,L as Vi,y as Hi}from"./index.08256667.js";import{d as pr,e as gr,D as Wr,f as ws,g as ji,h as xi,a as Wi,i as zi,c as Es,b as Gi,E as $i}from"./DbStore.d0cd5392.js";import{P as Mr}from"./bgPlaceholder.f57059f0.js";import{l as ys,m as Ts}from"./ProgressBar.svelte_svelte_type_style_lang.ec37df6e.js";import{_ as Pn}from"./preload-helper.a4192956.js";import{w as un}from"./index.eb17cf1d.js";import{f as $t}from"./formatDate.b9410829.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const co={"no-app":"No Firebase App '{$appName}' has been created - call initializeApp() first","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."},wt=new mr("app","Firebase",co);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _r=ao;function Ls(r,e={}){let t=r;typeof e!="object"&&(e={name:e});const n=Object.assign({name:sn,automaticDataCollectionEnabled:!1},e),s=n.name;if(typeof s!="string"||!s)throw wt.create("bad-app-name",{appName:String(s)});if(t||(t=Rs()),!t)throw wt.create("no-options");const i=Ur.get(s);if(i){if(Lr(t,i.options)&&Lr(n,i.config))return i;throw wt.create("duplicate-app",{appName:s})}const a=new _a(s);for(const l of an.values())a.addComponent(l);const o=new uo(t,n,a);return Ur.set(s,o),o}function ho(r=sn){const e=Ur.get(r);if(!e&&r===sn&&Rs())return Ls();if(!e)throw wt.create("no-app",{appName:r});return e}function Kt(r,e,t){var n;let s=(n=oo[r])!==null&&n!==void 0?n:r;t&&(s+=`-${t}`);const i=s.match(/\s|\//),a=e.match(/\s|\//);if(i||a){const o=[`Unable to register library "${s}" with version "${e}":`];i&&o.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&a&&o.push("and"),a&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Ut.warn(o.join(" "));return}lr(new Xt(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fo="firebase-heartbeat-database",po=1,cr="firebase-heartbeat-store";let Qr=null;function Us(){return Qr||(Qr=Da(fo,po,{upgrade:(r,e)=>{switch(e){case 0:r.createObjectStore(cr)}}}).catch(r=>{throw wt.create("idb-open",{originalErrorMessage:r.message})})),Qr}async function go(r){try{return await(await Us()).transaction(cr).objectStore(cr).get(Fs(r))}catch(e){if(e instanceof Et)Ut.warn(e.message);else{const t=wt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Ut.warn(t.message)}}}async function Un(r,e){try{const n=(await Us()).transaction(cr,"readwrite");await n.objectStore(cr).put(e,Fs(r)),await n.done}catch(t){if(t instanceof Et)Ut.warn(t.message);else{const n=wt.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});Ut.warn(n.message)}}}function Fs(r){return`${r.name}!${r.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wo(r){lr(new Xt("platform-logger",e=>new Ma(e),"PRIVATE")),lr(new Xt("heartbeat",e=>new _o(e),"PRIVATE")),Kt(nn,Ln,r),Kt(nn,Ln,"esm2017"),Kt("fire-js","")}wo("");var Eo="firebase",yo="10.1.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Kt(Eo,yo,"app");function fn(r,e){var t={};for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&e.indexOf(n)<0&&(t[n]=r[n]);if(r!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,n=Object.getOwnPropertySymbols(r);s<n.length;s++)e.indexOf(n[s])<0&&Object.prototype.propertyIsEnumerable.call(r,n[s])&&(t[n[s]]=r[n[s]]);return t}function Bs(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const To=Bs,Vs=new mr("auth","Firebase",Bs());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fr=new Ds("@firebase/auth");function So(r,...e){Fr.logLevel<=$.WARN&&Fr.warn(`Auth (${_r}): ${r}`,...e)}function kr(r,...e){Fr.logLevel<=$.ERROR&&Fr.error(`Auth (${_r}): ${r}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class br{constructor(e,t){this.shortDelay=e,this.longDelay=t,ot(t>e,"Short delay should be less than long delay!"),this.isMobile=ra()||sa()}get(){return ko()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Mo(r,e){return Ir(r,"POST","/v1/accounts:delete",e)}async function Lo(r,e){return Ir(r,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ur(r,e,t=!1){if(t)return e;try{return await e}catch(n){throw n instanceof Et&&Bo(n)&&r.auth.currentUser===r&&await r.auth.signOut(),n}}function Bo({code:r}){return r==="auth/user-disabled"||r==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ml="pendingRedirect",Pr=new Map;class Ll extends mi{constructor(e,t,n=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,n),this.eventId=null}async execute(){let e=Pr.get(this.auth._key());if(!e){try{const n=await Ul(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(n)}catch(t){e=()=>Promise.reject(t)}Pr.set(this.auth._key(),e)}return this.bypassAuthState||Pr.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function Ul(r,e){const t=Vl(e),n=Bl(r);if(!await n._isAvailable())return!1;const s=await n._get(t)==="true";return await n._remove(t),s}function Fl(r,e){Pr.set(r._key(),e)}function Bl(r){return at(r._redirectPersistence)}function Vl(r){return Rr(Ml,r.config.apiKey,r.name)}async function Hl(r,e,t=!1){const n=wr(r),s=gi(n,e),a=await new Ll(n,s,t).execute();return a&&!t&&(delete a.user._redirectEventId,await n._persistUserIfCurrent(a.user),await n._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zl(r,e={}){return Ir(r,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jl=new br(3e4,6e4);function Xn(){const r=Ye().___jsl;if(r!=null&&r.H){for(const e of Object.keys(r.H))if(r.H[e].r=r.H[e].r||[],r.H[e].L=r.H[e].L||[],r.H[e].r=[...r.H[e].L],r.CP)for(let t=0;t<r.CP.length;t++)r.CP[t]=null}}function Xl(r){return new Promise((e,t)=>{var n,s,i;function a(){Xn(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Xn(),t(Xe(r,"network-request-failed"))},timeout:Jl.get()})}if(!((s=(n=Ye().gapi)===null||n===void 0?void 0:n.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((i=Ye().gapi)===null||i===void 0)&&i.load)a();else{const o=qo("iframefcb");return Ye()[o]=()=>{gapi.load?a():t(Xe(r,"network-request-failed"))},ni(`https://apis.google.com/js/api.js?onload=${o}`).catch(l=>t(l))}}).catch(e=>{throw Dr=null,e})}let Dr=null;function Yl(r){return Dr=Dr||Xl(r),Dr}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hc="__/auth/handler",fc="emulator/auth/handler",pc=encodeURIComponent("fac");async function Qn(r,e,t,n,s,i){D(r.config.authDomain,r,"auth-domain-config-required"),D(r.config.apiKey,r,"invalid-api-key");const a={apiKey:r.config.apiKey,appName:r.name,authType:t,redirectUrl:n,v:_r,eventId:s};if(e instanceof _n){e.setDefaultLanguage(r.languageCode),a.providerId=e.providerId||"",da(e.getCustomParameters())||(a.customParameters=JSON.stringify(e.getCustomParameters()));for(const[h,m]of Object.entries(i||{}))a[h]=m}if(e instanceof Er){const h=e.getScopes().filter(m=>m!=="");h.length>0&&(a.scopes=h.join(","))}r.tenantId&&(a.tid=r.tenantId);const o=a;for(const h of Object.keys(o))o[h]===void 0&&delete o[h];const l=await r._getAppCheckToken(),d=l?`#${pc}=${encodeURIComponent(l)}`:"";return`${gc(r)}?${vr(o).slice(1)}${d}`}function gc({config:r}){return r.emulator?gn(r,fc):`https://${r.authDomain}/${hc}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bc(r){switch(r){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}function Ic(r){lr(new Xt("auth",(e,{options:t})=>{const n=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:a,authDomain:o}=n.options;D(a&&!a.includes(":"),"invalid-api-key",{appName:n.name});const l={apiKey:a,authDomain:o,clientPlatform:r,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:ei(r)},d=new el(n,s,i,l);return rl(d,t),d},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,n)=>{e.getProvider("auth-internal").initialize()})),lr(new Xt("auth-internal",e=>{const t=wr(e.getProvider("auth").getImmediate());return(n=>new _c(n))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),Kt(Zn,es,bc(r)),Kt(Zn,es,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
